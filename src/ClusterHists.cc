...
ClusterHists::ClusterHists()
{
  ...
  float edp_binNum = 200; //edp_rangeMax/edp_binWidth; //bin number will be the same for electrons and GeV units
  ...
  h_cluster_timing = new TH1F("cluster_timing", "Time of arrival of clusters [ns]", 2000, -1, 1);
  ...
  h_trackerhit_time  = new TH1F("trackerhit_time", ";Time (ns);Events" ,2000,-0.1,10); //-0.2 - 0.5
  h_trackerhit_time_layer0  = new TH1F("trackerhit_time_layer0", ";Time (ns);Events" ,2000,-0.1,10); //,200000,0,20
  h_trackerhit_time_layer1  = new TH1F("trackerhit_time_layer1", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer2  = new TH1F("trackerhit_time_layer2", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer3  = new TH1F("trackerhit_time_layer3", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer4  = new TH1F("trackerhit_time_layer4", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer5  = new TH1F("trackerhit_time_layer5", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer6  = new TH1F("trackerhit_time_layer6", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer7  = new TH1F("trackerhit_time_layer7", ";Time (ns);Events" ,2000,-0.1,10);
  h_trackerhit_time_layer8  = new TH1F("trackerhit_time_layer8", ";Time (ns);Events" ,2000,-0.1,10);
  ...
  h_thclen_cut = new TH1F("thclen_cut", ";Number of Hit Constituents; Events", 200, 15, 215); //Total number of hit constituents 
  //number of hits per cluster per layer: 
  h_thclen_layer0_cut = new TH1F("thclen_layer0_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer1_cut = new TH1F("thclen_layer1_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer2_cut = new TH1F("thclen_layer2_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer3_cut = new TH1F("thclen_layer3_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer4_cut = new TH1F("thclen_layer4_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer5_cut = new TH1F("thclen_layer5_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer6_cut = new TH1F("thclen_layer6_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer7_cut = new TH1F("thclen_layer7_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  h_thclen_layer8_cut = new TH1F("thclen_layer8_cut", ";Number of Hit Constituents; Events", 200, 15, 215);
  ...
  h_cluster_edep_thlen_cut = new TH2F("edep_vs_hitNum_cut" , ";Hits/Cluster; Energy Deposited (GeV)" , 200, 15, 215, edp_binNum,0,edp_rangeMax);
